...
import type { CreateUserDTO } from '../../../../../application/dtos/auth/create-user.dto.ts';
import { RegisterUserUseCase } from '../../../../../application/use-cases/auth/register-user.use-case.ts';
...
import type { RegisterBody } from '../../../schemas/v1/auth/register.schema.ts';
